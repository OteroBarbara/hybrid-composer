...
function faltaAccesibilidad() {
    ...
    if(document.getElementById("tvesModal")){
        ...
        document.body.innerHTML += '<div id="tvesModal" class="modalContainer"><div class="modal-content" style="position: fixed; top: 0px; background: #f5f7f8; display: block; margin:100px; padding:100px; height: 400px; overflow: scroll; border: gray 1px solid;"><button class="close" style="color: #7f7f7f; font-size: 20px; float: right; font-weight: bold;" onclick="cerrarModal()">Cerrar X</button><h2>Atención, error de accesibilidad</h2><p>Chequea los componentes de tu contenido marcados en rojo y verifica que hayas completado los campos de accesibilidad, accediendo al icono.<br></p><img class="imagen-chica" src="../wp-content/plugins/hybrid-composer/admin/images/icon-rueda.png" alt="Icono rueda de configuracion"><p>*Recuerda que las imágenes, los enlaces, iconos y botones deben estar correctamente etiquetados y contar con la debida descripción del elemento, ya sea un texto alternativo o una indicación para los lectores de pantalla.<br><br>Compruébalo con las imágenes de ejemplo que te compartimos a continuación.<br></p><img src="../wp-content/plugins/hybrid-composer/admin/images/descripcion.png"><br><img src="../wp-content/plugins/hybrid-composer/admin/images/alt-textvacio.png"><br><img src="../wp-content/plugins/hybrid-composer/admin/images/alt-textcomp.png"><br><br><button class="close" style="color: #7f7f7f; font-size: 20px; font-weight: bold; float: right;" onclick="cerrarModal()">Ok, entiendo.</button></div></div>';
    }
