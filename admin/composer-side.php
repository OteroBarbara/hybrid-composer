...
<div class="hc-co-box">
    ...
    <div class="hc-co-item">
        ...
        <a id="lock_button_hc" title="Locked mode" class="button lock-button-hc btn-icon-only" onclick=""><i class="icon-unlock"></i></a>
    </div>
    <div class="hc-co-item">
        <label>Json array</label>
        <a id="update_button_hc" title="Composer content" class="button btn-icon-only" onclick="showPageContentArr()"><i class="icon-code-fork"></i></a>
    </div>

    <div class="hc-co-item">
        <label>Templates</label>
        <a id="composer_templates_button_hc" title="Composer templates" class="button  btn-icon" onclick="showComposerTemplatesBox()"><i class="icon-folder-open"></i><?php esc_attr_e("Templates","hc") ?></a>
    </div>
    <div class="hc-co-item">
        <label>Clear cache</label>
        <a id="composer_clear_cache" title="Clear page cache and reload" class="button btn-icon-only" onclick="window.location = window.location.href + '&hc=cache' "><i class="icon-android-sync"></i></a>
    </div>
    <div class="hc-co-item">
        <label>Page css</label>
        <a id="css_button_hc" title="Page CSS" class="button btn-icon" onclick="showPageCSSbox()"><i class="icon-css3"></i>CSS</a>
    </div>
    <div class="hc-co-item">
        <label>Page options</label>
        <a class="button" href="#" id="hc-page-settings" onclick="showPageSettingsBox()"><i class="icon-gear-setting-2"></i></a>
    </div>
</div>
